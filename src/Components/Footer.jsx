...
const Footer = () => {
  return (
   ...
   <div className=' w-1/3 flex-col justify-between align-center m-auto' > <ul>
    ...
    <li className='flex items-center gap-2 mb-4'>  Instagram </li>
    <li className='flex items-center gap-2 mb-4'>  Facebook </li>
    <li className='flex items-center gap-2 mb-4'>  X</li> 
    </ul>
    </div>
